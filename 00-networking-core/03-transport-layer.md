...
- [1. Transport Layer Overview](#1-transport-layer-overview)
  - [Role and Position](#role-and-position)
  - [Multiplexing and Demultiplexing](#multiplexing-and-demultiplexing)
  - [Two Protocols](#two-protocols)
- [2. User Datagram Protocol (UDP)](#2-user-datagram-protocol-udp)
  - [Characteristics](#characteristics)
  - [UDP Header Structure](#udp-header-structure)
  - [Checksum Calculation](#checksum-calculation)
  - [When to Use UDP](#when-to-use-udp)
- [3. Principles of Reliable Data Transfer](#3-principles-of-reliable-data-transfer)
  - [3.1 Checksums — Detecting Corruption](#31-checksums-detecting-corruption)
  - [3.2 Retransmission Timers — Handling Loss](#32-retransmission-timers-handling-loss)
  - [3.3 Sequence Numbers — Detecting Duplicates and Reordering](#33-sequence-numbers-detecting-duplicates-and-reordering)
  - [3.4 Acknowledgments — Cumulative ACKs](#34-acknowledgments-cumulative-acks)
  - [3.5 Sliding Window — Throughput Control](#35-sliding-window-throughput-control)
- [4. Transmission Control Protocol (TCP)](#4-transmission-control-protocol-tcp)
  - [Characteristics](#characteristics)
  - [TCP Segment Header Structure](#tcp-segment-header-structure)
  - [Three-Way Handshake](#three-way-handshake)
  - [Connection Teardown](#connection-teardown)
  - [Flow Control via Receive Window](#flow-control-via-receive-window)
- [5. Congestion Control — Principles](#5-congestion-control-principles)
  - [What Is Congestion?](#what-is-congestion)
  - [Why Not Just Allocate Fixed Bandwidth?](#why-not-just-allocate-fixed-bandwidth)
  - [The Onset of Congestion](#the-onset-of-congestion)
  - [Kleinrock's Power Formula (1979)](#kleinrocks-power-formula-1979)
  - [Bandwidth Allocation Goals](#bandwidth-allocation-goals)
  - [Max-Min Fairness](#max-min-fairness)
  - [Efficiency vs. Fairness](#efficiency-vs-fairness)
  - [Convergence](#convergence)
- [6. Additive Increase Multiplicative Decrease (AIMD)](#6-additive-increase-multiplicative-decrease-aimd)
  - [Mechanism](#mechanism)
  - [Congestion Detection](#congestion-detection)
  - [The Saw-Tooth Pattern](#the-saw-tooth-pattern)
  - [Why AIMD Achieves Fairness](#why-aimd-achieves-fairness)
- [7. TCP Slow Start](#7-tcp-slow-start)
  - [Problem with Pure AIMD](#problem-with-pure-aimd)
  - [Slow Start Algorithm](#slow-start-algorithm)
  - [Slow-Start Threshold (ssthresh)](#slow-start-threshold-ssthresh)
- [8. TCP Congestion Types and Response](#8-tcp-congestion-types-and-response)
  - [Severe Congestion (Retransmission Timer Expiry)](#severe-congestion-retransmission-timer-expiry)
  - [Mild Congestion (3 Duplicate ACKs — Fast Retransmit)](#mild-congestion-3-duplicate-acks-fast-retransmit)
  - [Congestion Window Evolution — Full Picture](#congestion-window-evolution-full-picture)
  - [Comparison: Severe vs. Mild Congestion Response](#comparison-severe-vs-mild-congestion-response)
- [9. Socket Programming Basics](#9-socket-programming-basics)
  - [What Is a Socket?](#what-is-a-socket)
  - [UDP Socket Workflow](#udp-socket-workflow)
  - [TCP Socket Workflow](#tcp-socket-workflow)
- [Appendix: Key Formulas and Constants](#appendix-key-formulas-and-constants)
- [Appendix: Debugging Reference](#appendix-debugging-reference)
