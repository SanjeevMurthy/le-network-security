...
- [Overview](#overview)
- [1. Programs, Processes, and Threads](#1-programs-processes-and-threads)
  - [Definitions](#definitions)
  - [Why Processes Communicate Over Networks](#why-processes-communicate-over-networks)
  - [Communication Models](#communication-models)
- [2. Sockets](#2-sockets)
  - [What Is a Socket?](#what-is-a-socket)
  - [Socket Types](#socket-types)
  - [How Applications Use Sockets](#how-applications-use-sockets)
- [3. Ports and Addressing](#3-ports-and-addressing)
  - [The Two-Part Address](#the-two-part-address)
  - [Port Ranges](#port-ranges)
  - [Well-Known Ports Reference](#well-known-ports-reference)
  - [Servers vs. Clients: Port Assignment](#servers-vs-clients-port-assignment)
- [4. Application Layer Protocols Overview](#4-application-layer-protocols-overview)
  - [Role of the Application Layer](#role-of-the-application-layer)
  - [Key Protocols](#key-protocols)
  - [Client-Server Interaction Model](#client-server-interaction-model)
- [5. HTTP — The Web Protocol](#5-http-the-web-protocol)
  - [What Is HTTP?](#what-is-http)
  - [HTTP Versions](#http-versions)
  - [URL Anatomy](#url-anatomy)
  - [Web Objects](#web-objects)
  - [Non-Persistent vs. Persistent HTTP](#non-persistent-vs-persistent-http)
- [6. HTTP Request Messages](#6-http-request-messages)
  - [Message Structure](#message-structure)
  - [Example Request](#example-request)
  - [HTTP Methods](#http-methods)
  - [Common Request Headers](#common-request-headers)
  - [HTTP Message Structure Diagram](#http-message-structure-diagram)
- [7. HTTP Response Messages](#7-http-response-messages)
  - [Message Structure](#message-structure)
  - [Example Response](#example-response)
  - [Status Codes](#status-codes)
  - [Common Response Headers](#common-response-headers)
  - [Inspecting Real HTTP Responses](#inspecting-real-http-responses)
- [8. Cookies](#8-cookies)
  ...
  - [Cookie Use Cases](#cookie-use-cases)
  - [Third-Party Cookies and Privacy](#third-party-cookies-and-privacy)
- [Full Request-Response Cycle](#full-request-response-cycle)
- [Quick Reference](#quick-reference)
  - [Port Ranges Summary](#port-ranges-summary)
  - [HTTP Method Summary](#http-method-summary)
